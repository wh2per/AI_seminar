...
#Reading .npy files
train_data = np.load('/content/drive/My Drive/AI_seminar/CNN_image_classification/datasets/train_data_mc.npy', allow_pickle=True)
test_data = np.load('/content/drive/My Drive/AI_seminar/CNN_image_classification/datasets/test_data_mc.npy', allow_pickle=True)
